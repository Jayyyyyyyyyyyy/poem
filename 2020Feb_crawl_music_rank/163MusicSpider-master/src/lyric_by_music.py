...
def lyricSpider():
    ...
    my_lyric_comment = LyricComment()
    df = pd.read_csv('/Users/tangdou1/PycharmProjects/poem/2020Feb_crawl_music_rank/my_test_res.csv')

    for index, (org_song, res_song, music_id) in df.iterrows():

        lyric = my_lyric_comment.saveLyric(music_id)
        print(lyric)
